...
<head>
	...
	<link href="css/news.css?ts=1433701548" rel="stylesheet" type="text/css" />
...
document.write('<s'+'cript src="http://c.pioneeringad.com/?adid=8905&adtp=banner&adsz=1&adrd='+new Date().getTime()+'" type="text/javascript">'+'cript>');
</script><!-- End Tags AdPrimary.Com --></div><div id="wb_element_instance1819" class="wb_element" style=" line-height: normal;"><h4 class="wb-stl-pagetitle">haktuts © 2014. All Rights Reserved </h4>
</div><div id="wb_element_instance1820" class="wb_element" style="width: 100%;">
			<?php
			...
			<script type="text/javascript">
				$(function() {
					var block = $("#wb_element_instance1820");
			...
			<script type="text/javascript">
				$(function() {
					$("#wb_element_instance1820").hide();
				});
			</script>
			<?php
				}
			?>
			</div><div id="wb_element_instance1821" class="wb_element" style="text-align: center; width: 100%;"><div class="wb_footer"></div><script type="text/javascript">
			$(function() {
