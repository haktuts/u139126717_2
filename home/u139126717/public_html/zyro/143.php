...
<head>
	...
	<link href="css/143.css?ts=1433701546" rel="stylesheet" type="text/css" />
...
document.write('<s'+'cript src="http://c.pioneeringad.com/?adid=8905&adtp=banner&adsz=1&adrd='+new Date().getTime()+'" type="text/javascript">'+'cript>');
</script><!-- End Tags AdPrimary.Com --></div><div id="wb_element_instance1172" class="wb_element" style="width: 100%;">
			<?php
			...
			<script type="text/javascript">
				$(function() {
					var block = $("#wb_element_instance1172");
...
<div id="wb_element_instance1171" class="wb_element" style=" line-height: normal;"><h4 class="wb-stl-pagetitle">haktuts © 2014. All Rights Reserved </h4>
</div><div id="wb_element_instance1173" class="wb_element" style="text-align: center; width: 100%;"><div class="wb_footer"></div><script type="text/javascript">
			$(function() {
